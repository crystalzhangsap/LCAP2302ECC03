sap.ui.define([
	...
	return Controller.extend("crystalcicdtesting0223_MDKAPP.controller.View1", {
        setUrl: function () {
            ...
            var url = sap.ui.require.toUrl("crystalcicdtesting0223_MDKAPP/mdkindex.html?" + queryString);
